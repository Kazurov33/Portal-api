...
namespace api.Migrations
{
    ...
    [Migration("20200428133609_dapartment_update")]
    partial class dapartment_update
    {
            ...
            modelBuilder.Entity("Api.Models.Company.Department", b =>
                {
                    ...
                    b.Property<int?>("LowDepartmentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Api.Models.Company.Department", b =>
                {
                    ...
                    b.HasOne("Api.Models.Company.Department", "LowDepartment")
                        .WithMany()
                        .HasForeignKey("LowDepartmentId");
                });
